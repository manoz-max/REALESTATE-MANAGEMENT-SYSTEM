                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                <div class="select--box">
                                                    ...
                                                    <select name="city" id="city" required="true" style="background-color: black; color: white;">
                  ...
                  <?php } ?>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                <div class="select--box">
                                                    <i class="fa fa-angle-down"></i>
                                                    <select name="type" id="type" required="true" style="background-color: black; color: white;">
                                        <option value=""style="color: white;">Select Property Type</option>
                  ...
                  <?php } ?>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                            <div class="form-group">
                                                <div class="select--box">
                                                    <i class="fa fa-angle-down"></i>
                                                    <select name="status" id="status" required="true" style="background-color: black;color: white;">
...
?>
                                        ...
                                        <!-- .col-md-3 end -->
                                        <div class="col-xs-12 col-sm-6 col-md-3">
                                            <input type="submit" value="Search" name="search" class="btn btn--primary btn--block" style="background-color: #edca0c;">
                                        </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="heading heading-2 text-center mb-70">
                            <h2 class="heading--title" style="color: #edca0c;">Latest Properties</h2>
                        </div>
                        <!-- .heading-title end -->
                    </div>
                    <!-- .col-md-12 end -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                        ...
                        <a href="contact.php" class="btn btn--primary" style="background-color: #edca0c;">Contact</a>
                    </div>
                    <!-- .col-md-6 -->
                </div>
                <!-- .row -->
...
}(window, document, 'script', '7AEEDCB8-57A1-4463-B84E-2F0994D5BDF3', 'onboarding_bot', {
