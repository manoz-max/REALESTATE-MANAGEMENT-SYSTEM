...
<td><a href="new-reviews.php?rid=<?php echo $row['rid'];?>" onclick="return confirm('Do you really want to Approve this review ?')" class="btn btn-success">Approve</a> | 
    <a href="new-reviews.php?delrid=<?php echo $row['rid'];?>" onclick="return confirm('Do you really want to delete ?');" class="btn btn-danger">Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
