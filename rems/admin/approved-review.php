...
<td><a href="approved-review.php?rid=<?php echo $row['rid'];?>" onclick="return confirm('Do you really want to Unapprove this review ?')" class="btn btn-warning">Unapprove</a> | 
    <a href="approved-review.phpdelrid=<?php echo $row['rid'];?>" onclick="return confirm('Do you really want to delete ?')>" class="btn btn-danger">Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
