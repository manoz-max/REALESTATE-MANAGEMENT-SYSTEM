...
<body>
    ...
    <div class="splash-container">
        ...
        <div class="card ">
            <div class="card-header text-center"><h2 style="color: #edca0c;
">Bhavishya Nidhi</h2><span class="splash-description" style="color:white;">Please enter your user information.</span></div>
            <div class="card-body">
    ...
    echo $msg;
                    ...
                    <button type="submit" class="btn btn-primary btn-lg btn-block" name="login" style="color:white;">Sign in</button>
                </form>
            </div>
            <div class="card-footer bg-white p-0  " style="background-color: black;">
