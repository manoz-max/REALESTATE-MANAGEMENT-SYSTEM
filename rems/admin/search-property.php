...
<body>
    ...
    echo $msg;
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right" style="color:gold;">Search by Property ID/Name/Mobile No.:</label>
...
?>
              ...
              <td><?php  echo $row['PropertyTitle'];?></td>
                 ...
                 <td><?php  echo $row['MobileNumber'];?></td>
                  ...
                  <td><a href="view-property-details.php?viewid=<?php echo $row['ID'];?>" class="btn btn-primary">View</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
} } else { ?>
