...
<table class="table table-striped table-bordered first">
                  ...
                  <th style="color:gold;">User name</th>
                    <th style="color:gold;">Property </th> 
                    <th style="color:gold;">Review</th>    
                     <th style="color:gold;">Review Date</th>   
...
<td><a href="unapproved-reviews.php?rid=<?php echo $row['rid'];?>" onclick="return confirm('Do you really want to Approve this review ?')" class="btn btn-success">Approve</a> | 
    <a href="unapproved-reviews.php?delrid=<?php echo $row['rid'];?>" onclick="return confirm('Do you really want to delete ?')>" class="btn btn-danger">Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
