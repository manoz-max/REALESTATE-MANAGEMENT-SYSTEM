...
?>
                            ...
                            <?php } else{ ?>
                             <h5 style="color: #edca0c;">Posted by  Owner</h5>
                         <?php } ?>
                            </div>
                            <div class="widget--content">
                                <a href="#">
                                    ...
                                    <div class="agent--info">
                                        <h5 class="agent--title" style="color: white;"><?php echo $row1['FullName'];?></h5>
                                    </div>
                                </a>
                                <!-- .agent-profile-details end -->
                                <div class="agent--contact">
                                    <ul class="list-unstyled">
                                        <li style="color:white;"><i class="fa fa-phone"></i><?php echo $row1['MobileNumber'];?></li>
                                        <li style="color:white;"><i class="fa fa-envelope-o"></i><?php echo $row1['Email'];?></li>
