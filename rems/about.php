            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-5">
                        <div class="about--img"><img class="img-responsive" src="assets/images/about/1234.jpg" width="350" height="350" alt="about img"></div>
                    </div>
                    <!-- .col-md-5 -->
...
?>
                        <div class="heading heading-3">
                            <h2 class="heading--title" style="color: #edca0c"><?php echo $row['PageTitle'];?></h2>
                        </div>
                        <!-- .heading-title end -->
