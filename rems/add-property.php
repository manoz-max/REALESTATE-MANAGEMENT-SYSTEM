...
============================================= -->
    ...
    echo $msg;
                            ...
                            <div class="form-box">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <h4 class="form--title" style="color: #edca0c;">Property Description</h4>
                                    </div>
                                    <!-- .col-md-12 end -->
                                    <div class="col-xs-12 col-sm-12 col-md-12">
              ...
              ?>      
                  ...
                  <?php } ?>
                            ...
                            <div class="form-box">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <h4 class="form--title" style="color: #edca0c;">Property Features</h4>
                                    </div>
                                    <!-- .col-md-12 end -->
                            ...
                            <div class="form-box">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <h4 class="form--title" style="color: #edca0c;">Property Gallery</h4>
                                    </div>
                                    <!-- .col-md-12 end -->
                            ...
                            <div class="form-box">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <h4 class="form--title" style="color: #edca0c;">Property Location</h4>
                                    </div>
                                    <!-- .col-md-12 end -->
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="Zip/Postal-code">iframe Link</label>
