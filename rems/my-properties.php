                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 widget--about">
                            <div class="widget--content">
                                <div class="footer--logo">
                                    <img src="assets/images/logo/logo-dark2.png" alt="logo" width="92" height="80">
                                </div>
                                <p>BV Nagar, Nellore, Andhra Pradesh 524004</p>
                                <div class="footer--contact">
                                    <ul class="list-unstyled mb-0">
                                        <li>+91 9632587412</li>
                                        <li><a href="mailto:bhavishyanidhi@gmail.com" style="color:white;">bhavishyanidhi@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
